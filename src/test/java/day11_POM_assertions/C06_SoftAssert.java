...
public class C06_SoftAssert {
    ...
    public void webappTesti(){
        ...
        softAssert.assertEquals(actualSecim,expectedSecim,"Dropdown Eurozone secili degil");

        // 10. soft assert kullanarak DropDown listesinin su secenekleri oldugunu test edin "Select One", "Australia (dollar)", "Canada (dollar)","Switzerland (franc)",
        ...
        for (String each:expectedArr
            ...
            expectedOptionList.add(each);
        }
        softAssert.assertEquals(optionsStringList,expectedOptionList);
